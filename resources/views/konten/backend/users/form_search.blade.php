<table width='100%' class='pull-right' style='margin-bottom: 5px;'>
	<tr>
		<td>
			<input type='text' name='pencarian' 
			autofocus placeholder='search by nama...'
			id='pencarian' class='form-control' value='{{ Session::get("pencarian_user") }}'>
		</td>
		<td width='22%'>
...
function submit_search(){
	...
	$.ajax({
		url : '{!! URL::route("users.submit_search") !!}',
