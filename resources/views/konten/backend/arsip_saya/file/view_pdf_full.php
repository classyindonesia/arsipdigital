...
<link media="all" type="text/css" rel="stylesheet" href="<?php echo URL::to("/");?>/plugins/pdf_js/css/viewer.css">

<link rel="resource" type="application/l10n" href="<?php echo URL::to("/");?>/plugins/pdf_js/l10n/locale.properties"/>
<script src="<?php echo URL::to("/");?>/plugins/pdf_js/js/compatibility.js"></script>
<script src="<?php echo URL::to("/");?>/plugins/pdf_js/external/webL10n/l10n.js"></script>

<script src="<?php echo URL::to("/");?>/plugins/pdf_js/js/src/shared/util.js"></script>
<script src="<?php echo URL::to("/");?>/plugins/pdf_js/js/src/shared/colorspace.js"></script>
<script src="<?php echo URL::to("/");?>/plugins/pdf_js/js/src/shared/function.js"></script>
<script src="<?php echo URL::to("/");?>/plugins/pdf_js/js/src/shared/annotation.js"></script>
<script src="<?php echo URL::to("/");?>/plugins/pdf_js/js/src/display/api.js"></script>
<script src="<?php echo URL::to("/");?>/plugins/pdf_js/js/src/display/metadata.js"></script>
<script src="<?php echo URL::to("/");?>/plugins/pdf_js/js/src/display/canvas.js"></script>
<script src="<?php echo URL::to("/");?>/plugins/pdf_js/js/src/display/webgl.js"></script>
<script src="<?php echo URL::to("/");?>/plugins/pdf_js/js/src/display/pattern_helper.js"></script>
<script src="<?php echo URL::to("/");?>/plugins/pdf_js/js/src/display/font_loader.js"></script>




<script type="text/javascript">PDFJS.workerSrc = '<?php echo URL::to("/");?>/plugins/pdf_js/js/src/worker_loader.js';</script>


 
 <script src="<?php echo URL::to("/");?>/plugins/pdf_js/js/ui_utils.js"></script>
 <script src="<?php echo URL::to("/");?>/plugins/pdf_js/js/default_preferences.js"></script>
 <script src="<?php echo URL::to("/");?>/plugins/pdf_js/js/preferences.js"></script>
 <script src="<?php echo URL::to("/");?>/plugins/pdf_js/js/download_manager.js"></script>
 <script src="<?php echo URL::to("/");?>/plugins/pdf_js/js/view_history.js"></script>
 <script src="<?php echo URL::to("/");?>/plugins/pdf_js/js/page_view.js"></script>
 <script src="<?php echo URL::to("/");?>/plugins/pdf_js/js/thumbnail_view.js"></script>
 <script src="<?php echo URL::to("/");?>/plugins/pdf_js/js/text_layer_builder.js"></script>
 <script src="<?php echo URL::to("/");?>/plugins/pdf_js/js/pdf_find_bar.js"></script>
 <script src="<?php echo URL::to("/");?>/plugins/pdf_js/js/pdf_find_controller.js"></script>
 <script src="<?php echo URL::to("/");?>/plugins/pdf_js/js/pdf_history.js"></script>
 <script src="<?php echo URL::to("/");?>/plugins/pdf_js/js/secondary_toolbar.js"></script>
 <script src="<?php echo URL::to("/");?>/plugins/pdf_js/js/password_prompt.js"></script>
 <script src="<?php echo URL::to("/");?>/plugins/pdf_js/js/presentation_mode.js"></script>
 <script src="<?php echo URL::to("/");?>/plugins/pdf_js/js/grab_to_pan.js"></script>
 <script src="<?php echo URL::to("/");?>/plugins/pdf_js/js/hand_tool.js"></script>
 <script src="<?php echo URL::to("/");?>/plugins/pdf_js/js/document_properties.js"></script>
 <script src="<?php echo URL::to("/");?>/plugins/pdf_js/js/debugger.js"></script>
...
var DEFAULT_URL = '<?php echo URL::to("/");?>/upload/arsip/<?php echo $file->nama_file_tersimpan;?>';
